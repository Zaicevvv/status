...
const OptionsPage = () => (
  <section className={css.allOptionsSection}>
    ...
    <ul className={css.allOptionsSectionList}>
      ...
      <li className={css.allOptionsSectionP}>
        Компьютерная диагностика электронных систем (считывание ошибок из блока
      ...
      <li className={css.allOptionsSectionP}>
        Проверка качества технических жидкостей, расположенных в моторном отсеке
        (тормозная жидкость, жидкость системы сцепления, охлаждающая жидкость,
        жидкость омывателя)
      </li>
      <li className={css.allOptionsSectionP}>
      ...
      <li className={css.allOptionsSectionP}>Диагностика системы охлаждения</li>
      <li className={css.allOptionsSectionP}>
        Диагностика ситемы кондиционирования
      </li>
      <li className={css.allOptionsSectionP}>Диагностика топливной ситемы</li>
      <li className={css.allOptionsSectionP}>
        Проверка дымогенератором герметичности системы впуска, рециркуляции, фар
        и др.
      </li>
    </ul>
    <div className={css.anchorWrap}>
    ...
    <span className={css.allOptionsSectionSpan}>Техническое обслуживание</span>
    <ul className={css.allOptionsSectionList}>
      <li className={css.allOptionsSectionP}>
    ...
    <ul className={css.allOptionsSectionList}>
      ...
      <li className={css.allOptionsSectionP}>Регулировка подшипника ступицы</li>
    ...
    <ul className={css.allOptionsSectionList}>
      ...
      <li className={css.allOptionsSectionP}>
        Разборка и сборка роботизированной аба полуавтоматической КПП (например
        DSG, Power Shift)
      </li>
      <li className={css.allOptionsSectionP}>
    ...
    <ul className={css.allOptionsSectionList}>
      ...
      <li className={css.allOptionsSectionP}>Изготовление тормозной трубки</li>
      <li className={css.allOptionsSectionP}>
    ...
    <ul className={css.allOptionsSectionList}>
      ...
      <li className={css.allOptionsSectionP}>Замена прокладки головки блока</li>
      ...
      <li className={css.allOptionsSectionP}>Проверка на герметичность ГБЦ</li>
      <li className={css.allOptionsSectionP}>
      ...
      <li className={css.allOptionsSectionP}>Притирка седла и фасок клапана</li>
      <li className={css.allOptionsSectionP}>
      ...
      <li className={css.allOptionsSectionP}>Снятие и установка термостата</li>
    ...
    <ul className={css.allOptionsSectionList}>
      <li className={css.allOptionsSectionP}>Снятие и установка генератора</li>
    ...
    <ul className={css.allOptionsSectionList}>
      ...
      <li className={css.allOptionsSectionP}>Снятие и установка клапана ТРВ</li>
      <li className={css.allOptionsSectionP}>
